...
console.table(results.map((result) => ({
  ...
  activeFurniture: result.furnitureLayout.activeFurnitureCount,
  horizontalCuts: result.furnitureLayout.horizontalCutCount,
  verticalCuts: result.furnitureLayout.verticalCutCount,
  furnitureSpread: `${result.furnitureLayout.occupiedRowCount}r/${result.furnitureLayout.occupiedColumnCount}c`,
  maxSegments: `${result.furnitureLayout.maxHorizontalSegments}h/${result.furnitureLayout.maxVerticalSegments}v`,
