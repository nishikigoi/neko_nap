...
const translations = {
  en: {
    ...
    ruleFurniture: "Furniture blocks their view.",
    ...
    furniture: "furniture that blocks horizontal and vertical sight",
    floor: "floor",
  ...
  ja: {
    ...
    ruleFurniture: "家具が間にあれば、安心して眠れます。",
    levelsHeading: "ステージ",
    start: "スタート",
    level: "ステージ",
    completed: "クリア済み",
